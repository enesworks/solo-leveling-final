...
import dev.eness.sololevelingfinal.core.procedures.CurseMagicOnEntityTickUpdateProcedure;
...
public class CurseMagicEntity extends PathfinderMob {
   ...
   public CurseMagicEntity(SpawnEntity packet, Level world) {
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.add(Attributes.MAX_HEALTH, 99.0);
