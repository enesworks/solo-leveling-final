...
public class SkeletonWarriorEntity extends Monster implements GeoEntity {
   ...
   public SkeletonWarriorEntity(SpawnEntity packet, Level world) {
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.wither_skeleton.step")), 0.15F, 1.0F);
   }
