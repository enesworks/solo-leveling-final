...
import dev.eness.sololevelingfinal.core.procedures.SpiderBossEntityDiesProcedure;
import dev.eness.sololevelingfinal.core.procedures.SpiderBossEntityIsHurtProcedure;
import dev.eness.sololevelingfinal.core.procedures.SpiderBossOnEntityTickUpdateProcedure;
...
public class SpiderBossEntity extends Monster implements GeoEntity {
   ...
   public SpiderBossEntity(SpawnEntity packet, Level world) {
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.spider.step")), 0.15F, 1.0F);
   }
