...
import dev.eness.sololevelingfinal.core.procedures.GoblinClubOnEntityTickUpdateProcedure;
...
public class GoblinClubEntity extends Monster implements GeoEntity, DungeonScalableEntity {
   ...
   public GoblinClubEntity(SpawnEntity packet, Level world) {
   ...
   public GoblinClubEntity(EntityType<GoblinClubEntity> type, Level world) {
      ...
      this.xpReward = 0;
      this.setNoAi(false);
      this.setCustomName(Component.literal("Goblin"));
