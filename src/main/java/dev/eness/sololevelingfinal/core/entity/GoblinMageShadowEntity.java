...
import dev.eness.sololevelingfinal.core.procedures.GoblinMageShadowOnEntityTickUpdateProcedure;
...
public class GoblinMageShadowEntity extends TamableAnimal implements GeoEntity {
   ...
   public GoblinMageShadowEntity(SpawnEntity packet, Level world) {
