...
import dev.eness.sololevelingfinal.core.procedures.IsNotBerserkProcedure;
import dev.eness.sololevelingfinal.core.procedures.ShadowIgrisEntityDiesProcedure;
import dev.eness.sololevelingfinal.core.procedures.ShadowIgrisRightClickedOnEntityProcedure;
...
public class ShadowIgrisEntity extends TamableAnimal implements GeoEntity {
   ...
   public ShadowIgrisEntity(SpawnEntity packet, Level world) {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(16, new FollowOwnerGoal(this, 1.0, 30.0F, 5.0F, false) {
         @Override
         public boolean canUse() {
            double x = ShadowIgrisEntity.this.getX();
            double y = ShadowIgrisEntity.this.getY();
   ...
   public static Builder createAttributes() {
      ...
      builder = builder.add(Attributes.ARMOR, 65.0);
