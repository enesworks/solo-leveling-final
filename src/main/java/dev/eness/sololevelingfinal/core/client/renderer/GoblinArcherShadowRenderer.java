...
import dev.eness.sololevelingfinal.core.entity.model.GoblinArcherShadowModel;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class GoblinArcherShadowRenderer extends GeoEntityRenderer<GoblinArcherShadowEntity> {
   public GoblinArcherShadowRenderer(Context renderManager) {
   ...
   public void preRender(
      PoseStack poseStack,
      GoblinArcherShadowEntity entity,
      BakedGeoModel model,
