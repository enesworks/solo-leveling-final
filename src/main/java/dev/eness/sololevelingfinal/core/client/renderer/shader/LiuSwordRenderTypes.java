...
public final class LiuSwordRenderTypes extends RenderStateShard {
   ...
   public static void registerShaders(RegisterShadersEvent event) throws IOException {
      event.registerShader(
         new ShaderInstance(event.getResourceProvider(), new ResourceLocation("sololeveling", "rendertype_liu_sword"), WorldShaderVertexFormat.NEW_ENTITY),
   ...
   public static RenderType effect(ResourceLocation fallback) {
      ...
      return RenderType.create("liu_sword_vfx", WorldShaderVertexFormat.NEW_ENTITY, Mode.QUADS, 1024, false, true, state);
   }
}
