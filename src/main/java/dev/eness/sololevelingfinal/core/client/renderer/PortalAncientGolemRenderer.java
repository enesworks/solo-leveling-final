...
import dev.eness.sololevelingfinal.core.entity.model.PortalAncientGolemModel;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class PortalAncientGolemRenderer extends GeoEntityRenderer<PortalAncientGolemEntity> {
   public PortalAncientGolemRenderer(Context renderManager) {
   ...
   public void preRender(
      PoseStack poseStack,
      PortalAncientGolemEntity entity,
      BakedGeoModel model,
