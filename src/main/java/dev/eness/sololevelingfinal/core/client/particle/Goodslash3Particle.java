...
public class Goodslash3Particle extends TextureSheetParticle {
   ...
   public static Goodslash3Particle.Goodslash3ParticleProvider provider(SpriteSet spriteSet) {
      return new Goodslash3Particle.Goodslash3ParticleProvider(spriteSet);
   }
   ...
   public static class Goodslash3ParticleProvider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         return new Goodslash3Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
      }
   }
}
