...
import dev.eness.sololevelingfinal.core.entity.layer.AttackshardLayer;
import dev.eness.sololevelingfinal.core.entity.model.AttackshardModel;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class AttackshardRenderer extends GeoEntityRenderer<AttackshardEntity> {
   public AttackshardRenderer(Context renderManager) {
