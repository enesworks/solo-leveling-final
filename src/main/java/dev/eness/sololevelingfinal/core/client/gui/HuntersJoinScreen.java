...
import dev.eness.sololevelingfinal.core.network.HuntersJoinButtonMessage;
import dev.eness.sololevelingfinal.core.procedures.HuntersLevelReqProcedure;
...
public class HuntersJoinScreen extends AbstractContainerScreen<HuntersJoinMenu> {
   private static final HashMap<String, Object> guistate = HuntersJoinMenu.guistate;
   ...
   protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
      ...
      guiGraphics.drawString(this.font, HuntersLevelReqProcedure.execute(this.entity), -27, 17, -12829636, false);
   }
   ...
   public void init() {
      ...
      this.imagebutton_guildjoin = new ImageButton(
         ...
         24,
         e -> {
            SololevelingMod.PACKET_HANDLER.sendToServer(new HuntersJoinButtonMessage(0, this.x, this.y, this.z));
            HuntersJoinButtonMessage.handleButtonAction(this.entity, 0, this.x, this.y, this.z);
         }
      );
