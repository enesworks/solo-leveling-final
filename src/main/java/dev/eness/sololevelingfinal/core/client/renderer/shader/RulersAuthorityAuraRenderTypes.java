...
public class RulersAuthorityAuraRenderTypes extends RenderStateShard {
   ...
   public static void registerShaders(RegisterShadersEvent event) throws IOException {
      event.registerShader(
         new ShaderInstance(
            event.getResourceProvider(), new ResourceLocation("sololeveling", "rendertype_rulers_authority_aura"), WorldShaderVertexFormat.NEW_ENTITY
         ),
   ...
   public static RenderType aura(ResourceLocation texture) {
      ...
      return RenderType.create("rulers_authority_aura", WorldShaderVertexFormat.NEW_ENTITY, Mode.QUADS, 1024, false, true, state);
   }
}
