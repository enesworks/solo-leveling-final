...
import dev.eness.sololevelingfinal.core.entity.model.RandomCaveLargeModel;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;

public class RandomCaveLargeRenderer extends GeoEntityRenderer<RandomCaveLargeEntity> {
   public RandomCaveLargeRenderer(Context renderManager) {
