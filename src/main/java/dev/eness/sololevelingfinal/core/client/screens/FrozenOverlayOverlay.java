...
import dev.eness.sololevelingfinal.core.procedures.FrozenOverlayDisplayOverlayIngameProcedure;
...
public class FrozenOverlayOverlay {
   ...
   public static void eventHandler(Pre event) {
      ...
      if (visible) {
         ...
         if (visible) {
            event.getGuiGraphics().blit(new ResourceLocation("sololeveling:textures/screens/freezescreen.png"), 0, 0, 0.0F, 0.0F, w, h, w, h);
         }
