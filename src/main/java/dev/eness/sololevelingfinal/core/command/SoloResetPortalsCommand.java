...
import dev.eness.sololevelingfinal.core.procedures.PortalResetCommandProcedure;
...
public class SoloResetPortalsCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("soloresetportals").requires(s -> s.hasPermission(3))).executes(arguments -> {
