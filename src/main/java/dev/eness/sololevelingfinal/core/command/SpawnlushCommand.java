...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceLushProcedure;
...
public class SpawnlushCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnlush").requires(s -> s.hasPermission(4))).executes(arguments -> {
