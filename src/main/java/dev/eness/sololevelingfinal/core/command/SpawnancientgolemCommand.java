...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceAncientgolemProcedure;
...
public class SpawnancientgolemCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnancientgolem").requires(s -> s.hasPermission(4))).executes(arguments -> {
