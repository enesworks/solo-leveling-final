...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceKargalganProcedure;
...
public class SpawnkargalgandungeonCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnkargalganthrone").requires(s -> s.hasPermission(4)))
               .executes(arguments -> {
