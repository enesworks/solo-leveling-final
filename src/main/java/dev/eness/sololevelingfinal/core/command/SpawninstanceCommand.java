...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceInstanceProcedure;
...
public class SpawninstanceCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawninstance").requires(s -> s.hasPermission(4))).executes(arguments -> {
