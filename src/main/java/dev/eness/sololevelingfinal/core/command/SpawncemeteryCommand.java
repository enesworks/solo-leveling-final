...
import dev.eness.sololevelingfinal.core.procedures.RandomCemeteryProcedure;
...
public class SpawncemeteryCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawncemetery").requires(s -> s.hasPermission(4))).executes(arguments -> {
