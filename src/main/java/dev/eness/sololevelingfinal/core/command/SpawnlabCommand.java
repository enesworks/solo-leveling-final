...
import dev.eness.sololevelingfinal.core.procedures.RandomLabProcedure;
...
public class SpawnlabCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnlab").requires(s -> s.hasPermission(4))).executes(arguments -> {
