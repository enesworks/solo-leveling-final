...
import dev.eness.sololevelingfinal.core.procedures.RandomCorridor1Procedure;
...
public class SpawnrandomCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnrandom").requires(s -> s.hasPermission(4))).executes(arguments -> {
