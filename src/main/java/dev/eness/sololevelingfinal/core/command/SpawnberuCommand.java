...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceBeruProcedure;
...
public class SpawnberuCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnberu").requires(s -> s.hasPermission(4))).executes(arguments -> {
