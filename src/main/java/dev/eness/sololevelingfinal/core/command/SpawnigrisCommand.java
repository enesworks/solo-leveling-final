...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceIgrisProcedure;
...
public class SpawnigrisCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnigris").requires(s -> s.hasPermission(4))).executes(arguments -> {
