...
import dev.eness.sololevelingfinal.core.procedures.DunPlaceRandomLargeProcedure;
...
public class SpawnrandomlargeCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("spawnrandomlarge").requires(s -> s.hasPermission(4))).executes(arguments -> {
