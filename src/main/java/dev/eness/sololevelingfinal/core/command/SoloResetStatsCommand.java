...
import dev.eness.sololevelingfinal.core.procedures.TemporaryResetButtonOnKeyPressedProcedure;
...
public class SoloResetStatsCommand {
   ...
   public static void registerCommand(RegisterCommandsEvent event) {
      event.getDispatcher()
         .register(
            (LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("soloresetstats").requires(s -> s.hasPermission(3))).executes(arguments -> {
