            ...
            if (!world.isClientSide()) {
               if (entity instanceof TamableAnimal _tamEnt
                  ...
                  if (world instanceof ServerLevel _level) {
                     _level.sendParticles(ParticleTypes.SMOKE, entity.getX(), entity.getY(), entity.getZ(), 15, 0.05, 0.05, 0.05, 1.0);
                  }
               ...
               if (entity.getPersistentData().getDouble("IA") == 312.0) {
                  ...
                  if (world instanceof ServerLevel _level) {
                     _level.sendParticles(ParticleTypes.EXPLOSION, x, y, z, 3, 0.1, 0.1, 0.1, 1.0);
                  }

                  if (world instanceof ServerLevel _level) {
                     _level.sendParticles(ParticleTypes.FLAME, x, y, z, 100, 10.0, 2.0, 10.0, 0.0);
                  }

                  if (world instanceof ServerLevel _level) {
                     _level.sendParticles(ParticleTypes.LAVA, x, y, z, 25, 10.0, 2.0, 10.0, 0.0);
                  }
                  ...
                  for (Entity entityiterator : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(12.0), e -> true)
                     ...
                     if (entityiterator instanceof LivingEntity living
                        ...
                        living.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 20, 5, false, false));
                        living.hurt(
