...
public class SpecialCraftingGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
   ...
   public SpecialCraftingGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
      ...
      this.customSlots.put(0, this.addSlot(new SlotItemHandler(this.internal, 0, -8, -120) {
      ...
      this.customSlots.put(1, this.addSlot(new SlotItemHandler(this.internal, 1, 42, -48) {
      ...
      this.customSlots.put(2, this.addSlot(new SlotItemHandler(this.internal, 2, -58, -48) {
      ...
      this.customSlots.put(3, this.addSlot(new SlotItemHandler(this.internal, 3, -8, -74) {
