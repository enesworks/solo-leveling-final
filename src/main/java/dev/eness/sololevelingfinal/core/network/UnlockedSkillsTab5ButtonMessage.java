...
public class UnlockedSkillsTab5ButtonMessage {
   ...
   public static void handler(UnlockedSkillsTab5ButtonMessage message, Supplier<Context> contextSupplier) {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      SololevelingMod.addNetworkMessage(
         UnlockedSkillsTab5ButtonMessage.class,
         UnlockedSkillsTab5ButtonMessage::buffer,
         UnlockedSkillsTab5ButtonMessage::new,
         UnlockedSkillsTab5ButtonMessage::handler
      );
   }
}
