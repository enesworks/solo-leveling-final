...
import dev.eness.sololevelingfinal.core.procedures.ShadowGUIOpenProcedure;
import dev.eness.sololevelingfinal.core.procedures.SpeedPercentDecreaseProcedure;
import dev.eness.sololevelingfinal.core.procedures.SpeedPercentIncreaseProcedure;
import dev.eness.sololevelingfinal.core.procedures.TjEnableProcedure;
...
public class AbilitiesGUIButtonMessage {
   ...
   public static void handler(AbilitiesGUIButtonMessage message, Supplier<Context> contextSupplier) {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      SololevelingMod.addNetworkMessage(
         AbilitiesGUIButtonMessage.class, AbilitiesGUIButtonMessage::buffer, AbilitiesGUIButtonMessage::new, AbilitiesGUIButtonMessage::handler
      );
   }
}
