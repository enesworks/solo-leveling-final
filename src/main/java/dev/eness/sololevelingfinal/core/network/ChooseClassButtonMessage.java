...
import dev.eness.sololevelingfinal.core.procedures.ClassChooseButtonProcedure;
...
public class ChooseClassButtonMessage {
   ...
   public static void handler(ChooseClassButtonMessage message, Supplier<Context> contextSupplier) {
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      SololevelingMod.addNetworkMessage(
         ChooseClassButtonMessage.class, ChooseClassButtonMessage::buffer, ChooseClassButtonMessage::new, ChooseClassButtonMessage::handler
      );
   }
}
