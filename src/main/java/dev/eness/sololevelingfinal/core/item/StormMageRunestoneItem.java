...
public final class StormMageRunestoneItem extends Item {
   ...
   public void appendHoverText(ItemStack stack, Level level, List<Component> tooltip, TooltipFlag flag) {
      ...
      tooltip.add(Component.literal("Storm Current evolves through Intelligence and System Level.").withStyle(ChatFormatting.AQUA));
      tooltip.add(Component.literal("White-Flame Spiritualization temporarily raises output by one stage.").withStyle(ChatFormatting.WHITE));
   }
   ...
   public boolean isBaranInheritanceSkill() {
      return StormMageSpellManager.BARAN_CROSSOVER_SKILLS.contains(this.skill);
   }
}
